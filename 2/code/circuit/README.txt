...
The code distribution contains the following files:
  * circuit.{py, rb} - pset (stripped) versions of the circuit simulator
  * circuit_test.py - unit test for circuit.py
  * full_circuit.{py, rb} - full implementations of the circuit simulator
  ...
  * test/*.svg - circuit layouts for the test inputs
